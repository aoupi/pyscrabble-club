...
class GameTile(gtk.Button, Tile):
    ...
    def findStyle(self, x, y):
        ...
        if ( pos in DOUBLE_LETTERS ):
            if o.get_default_bool_option(USE_COLOR_DOUBLE_LETTER_TILE, True):
                self.setStyle(TILE_DOUBLE_LETTER, o.get_default_option(COLOR_DOUBLE_LETTER_TILE,TILE_COLORS[TILE_DOUBLE_LETTER]))
            else:
            ...
            if o.get_default_bool_option(USE_COLOR_TRIPLE_LETTER_TILE, True):
                self.setStyle(TILE_TRIPLE_LETTER, o.get_default_option(COLOR_TRIPLE_LETTER_TILE, TILE_COLORS[TILE_TRIPLE_LETTER]))
            else:
            ...
            if o.get_default_bool_option(USE_COLOR_DOUBLE_WORD_TILE, True):
                self.setStyle(TILE_DOUBLE_WORD, o.get_default_option(COLOR_DOUBLE_WORD_TILE, TILE_COLORS[TILE_DOUBLE_WORD]))
            else:
            ...
            if o.get_default_bool_option(USE_COLOR_TRIPLE_WORD_TILE, True):
                self.setStyle(TILE_TRIPLE_WORD, o.get_default_option(COLOR_TRIPLE_WORD_TILE, TILE_COLORS[TILE_TRIPLE_WORD]))
            else:
