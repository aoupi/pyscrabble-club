...
class OptionWindow(gtk.Window):
    ...
    def getColorPrefs(self):
        ...
        b = gtkutil.createColorPreference(COLOR_DOUBLE_LETTER_TILE, TILE_COLORS[TILE_DOUBLE_LETTER], USE_COLOR_DOUBLE_LETTER_TILE, _('Background color for double letter tiles: '), self.tips, _('This will be the background color for double letter tiles'))
        box.pack_start( b, False, False, 5 )

        b = gtkutil.createColorPreference(COLOR_TRIPLE_LETTER_TILE, TILE_COLORS[TILE_TRIPLE_LETTER], USE_COLOR_TRIPLE_LETTER_TILE, _('Background color for triple letter tiles: '), self.tips, _('This will be the background color for triple letter tiles'))
        box.pack_start( b, False, False, 5 )

        b = gtkutil.createColorPreference(COLOR_DOUBLE_WORD_TILE, TILE_COLORS[TILE_DOUBLE_WORD], USE_COLOR_DOUBLE_LETTER_TILE, _('Background color for double word tiles: '), self.tips, _('This will be the background color for double word tiles'))
        box.pack_start( b, False, False, 5 )

        b = gtkutil.createColorPreference(COLOR_TRIPLE_WORD_TILE, TILE_COLORS[TILE_TRIPLE_WORD], USE_COLOR_TRIPLE_WORD_TILE, _('Background color for triple word tiles: '), self.tips, _('This will be the background color for triple word tiles'))
        box.pack_start( b, False, False, 5 )
        return box
