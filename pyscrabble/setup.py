...
if HAS_PY2EXE and 'py2exe' in sys.argv:
    ...
    try:
        ...
        print 'import error'
    kwargs['py_modules'] = ['pyscrabble-client', 'pyscrabble-server', 'pyscrabble-db_upgrade']
    kwargs['options'] = {
         "py2exe": {
    ...
    kwargs['scripts'] = ['pyscrabble-client', 'pyscrabble-server', 'pyscrabble-db_upgrade']
